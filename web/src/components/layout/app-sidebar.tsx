    ...
    >
      ...
      <div className="shrink-0 space-y-1 border-t border-gray-200 p-3 dark:border-gray-800">
        <button
          ...
          onClick={onSignOut}
          className={cn(
            'flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/8',
        ...
        {isDesktop && (
          <button
            ...
            className={cn(
              'mt-1 flex w-full items-center gap-3 rounded-xl border border-gray-200 px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/5',
              !showLabels && 'justify-center',
            )}
